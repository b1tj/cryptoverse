    ...
    return (
        <Col className="coin-detail-container">
            ...
            <Row justify="space-between">
                <Col lg={10} xs={24} className="stats-container">
                    <Col span={24} className="coin-value-statistics">
            ...
            <Row className="coin-desc-link" justify="space-between">
                ...
                <Col lg={10} className="coin-links">
                    <Title level={3} className="coin-details-heading">
